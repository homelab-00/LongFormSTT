...
def graceful_exit(sock):
    ...
    for proc in psutil.process_iter(['pid', 'name', 'cmdline']):
        ...
        if proc.info['name'] == 'AutoHotkeyU64.exe':
            ...
            if "Hotkeys-AHK_A1.ahk" in cmdline_str:
                console.print("[bold red]Killing AHK script (Hotkeys-AHK_A1.ahk)...[/bold red]")
                proc.kill()
...
def startup():
    ...
    ahk_path = os.path.join(script_dir, "Hotkeys-AHK_A1.ahk")
