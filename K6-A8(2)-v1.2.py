...
class Transcriber:
    ...
    def transcribe_audio_data(self, audio):
        ...
        try:
            # Set task to "translate" for non-English/Greek languages
            task = "translate" if self.config.language not in ["en", "el"] else "transcribe"
    ...
    def transcribe(self, audio_path: str, use_realtime_language: bool = False) -> str:
        ...
        try:
            ...
            # We only need the task parameter - faster-whisper defaults to English translation
                        ...
                        if self.is_speech_active:
                            ...
                            if (current_time - silence_start_time) * 1000 >= self.silence_threshold_ms:
                                ...
                                if current_segment:
                                    ...
                                    # Determine task - translate for non-English/Greek languages
                                    transcription_task = "translate" if self.config.realtime_language not in ["en", "el"] else "transcribe"
