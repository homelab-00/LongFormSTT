...
class TrayManager:
    ...
    def _init_icons(self) -> None:
        """Initialize all tray icons."""
        size = 24
        self.icons = {
            'gray': self._create_circle_icon(size, (128, 128, 128, 255)),
            'red': self._create_circle_icon(size, (255, 0, 0, 255)),
            'blue': self._create_circle_icon(size, (0, 128, 255, 255)),
            'yellow': self._create_circle_icon(size, (255, 255, 0, 255))
        }
