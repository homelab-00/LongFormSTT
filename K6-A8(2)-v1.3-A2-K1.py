    ...
    def transcribe_audio_data(self, audio):
        ...
        try:
            ...
            if stt_language not in ["en", "el"]:
                stt_task = "translate"
                translate_kwargs = {"translate_to": "en"}
    ...
    def transcribe(self, audio_path: str, use_realtime_language: bool = False) -> str:
        ...
        try:
            ...
            if language not in ["en", "el"]:
                task = "translate"  # This will translate to English by default
                        ...
                        if self.is_speech_active:
                            ...
                            if (current_time - silence_start_time) * 1000 >= self.silence_threshold_ms:
                                ...
                                if current_segment:
                                    ...
                                    # Use config.realtime_language for real-time transcription
                                    if self.config.realtime_language not in ["en", "el"]:
                                        transcription_task = "translate"  # This will translate to English by default
                                        translate_kwargs = {"translate_to": "en"}  # Keep the translate_to parameter - it's needed!
                                    else:
