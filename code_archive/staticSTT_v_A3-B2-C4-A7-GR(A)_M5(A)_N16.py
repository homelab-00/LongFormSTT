...
def stop_recording_and_transcribe():
    ...
    # Instead of keyboard.release_all(), release each hotkey individually.
    console.print("[blue]Releasing hotkeys F2, F3, and F4 to reset hotkey state...[/blue]")
    try:
        keyboard.release("F2")
        keyboard.release("F3")
        keyboard.release("F4")
    except Exception as e:
        console.print(f"[red]Failed to release keys: {e}[/red]")
