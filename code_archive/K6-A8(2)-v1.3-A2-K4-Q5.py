...
class UnifiedConfigDialog:
    def __init__(self, config: Config, console: Console, realtime_handler, transcriber):
        self.config = config
        self.console = console
        ...
        self.priority_languages = {
            "en": emoji.emojize(":flag_gb: English (en)", language='alias'),
            "el": emoji.emojize(":flag_gr: Greek (el)", language='alias'),
            "ru": emoji.emojize(":flag_ru: Russian (ru)", language='alias'),
            "zh": emoji.emojize(":flag_cn: Chinese (zh)", language='alias'),
            "de": emoji.emojize(":flag_de: German (de)", language='alias'),
            "fr": emoji.emojize(":flag_fr: French (fr)", language='alias')
        }
    ...
    def show_dialog(self):
        ...
        def apply_selections():
            ...
            result["realtime_model_name"] = realtime_audio_var.get()
