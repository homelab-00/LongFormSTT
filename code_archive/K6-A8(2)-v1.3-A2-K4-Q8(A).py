...
# --------------------------------------------------------------------------------------
class Transcriber:
    def __init__(self, config: Config, console: Console, model_id: str = None):
        self.config = config
        self.console = console
...
class RealtimeTranscriptionHandler:
    def __init__(self, config: Config, console: Console, transcriber: Transcriber, tray: TrayManager, model_name: str = None):
        self.config = config
        self.console = console
        self.transcriber = transcriber
        self.tray = tray
